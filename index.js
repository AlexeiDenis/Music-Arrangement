...
function PlayChoir() {
    ...
    x.onpause = () => { ch.style.backgroundColor = "#F6EBEB"; ch.classList.remove('animatie'); }
    x.onended = () => { ch.style.backgroundColor = "#F6EBEB"; ch.classList.remove('animatie'); }
}
function PlaySynth() {
    ...
    x.onpause = () => { synth.style.backgroundColor = "#F6EBEB"; synth.classList.remove('animatie'); }
    x.onended = () => { synth.style.backgroundColor = "#F6EBEB"; synth.classList.remove('animatie'); }
}
function PlayStrings() {
    ...
    x.onpause = () => { s.style.backgroundColor = "#F6EBEB"; s.classList.remove('animatie'); }
    x.onended = () => { s.style.backgroundColor = "#F6EBEB"; s.classList.remove('animatie'); }
...
function PlayBass1() {
    ...
    x.onpause = () => {
        divbass1.style.backgroundColor = "#F6EBEB"; divbass1.classList.remove('animatie');
    }
    x.onended = () => {
        divbass1.style.backgroundColor = "#F6EBEB"; divbass1.classList.remove('animatie');
    }
...
function PlayBass2() {
    ...
    x.onpause = () => {
        divbass2.style.backgroundColor = "#F6EBEB"; divbass2.classList.remove('animatie');
    }
    x.onended = () => {
        divbass2.style.backgroundColor = "#F6EBEB"; divbass2.classList.remove('animatie');
    }
...
function PlayKeyboard(e) {
    ...
    x.onended = () => { y.style.backgroundColor = "#F6EBEB"; y.classList.remove('animatie'); }
    x.onpause = () => { y.style.backgroundColor = "#F6EBEB"; y.classList.remove('animatie'); }
